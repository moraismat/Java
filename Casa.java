...
public class Casa {
    ...
    /*
     * Metodo usado para verificar se a proxima casa eh a casa segura correspondente a cor da peça.
     * Caso seja, jogador entra na zona segura.
     * Senao, jogador continua em frente.
     */
    public Casa qualEhCasa(Peca peca){
        if(this.ehEntradaZonaSegura() && this.getCasaSegura().getCor().equals(peca.obterCor())){
            return casaSegura;
        }
        else{
            return casaSeguinte;
